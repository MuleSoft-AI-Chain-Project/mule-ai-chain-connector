...
import org.mule.extension.mulechain.internal.connection.parameter.MistralAIConnectionParameter;
...
@ExternalLib(
    name = "MistralAI Library",
    description = "MistralAI Library",
    type = JAR,
    nameRegexpMatcher = "langchain4j-mistral-ai.*.jar")
@Alias("mistralAI")
