...
import org.mule.extension.mulechain.internal.connection.parameter.AnthropicConnectionParameter;
...
@ExternalLib(
    ...
    description = "Anthropic Library",
    type = JAR,
    nameRegexpMatcher = "langchain4j-anthropic.*.jar")
@Alias("anthropic")
